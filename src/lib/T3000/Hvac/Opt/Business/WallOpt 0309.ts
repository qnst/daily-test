...
WallOpt.prototype.GetToolList = function () {
  var e,
    t = [];
...
WallOpt.prototype.AddWall = function (e, t) {
...
WallOpt.prototype.StartAddingWalls = function () {
 ...
 */
WallOpt.prototype.StopAddingWalls = function (skipMessageUnlock) {
...
WallOpt.prototype.CancelObjectDraw = function () {
  this.StopAddingWalls()
}

WallOpt.prototype.ToggleAddingWalls = function (e) {

  this.addingWalls = null != e ? e : !this.addingWalls
}

WallOpt.prototype.IsAddingWalls = function () {
  return this.addingWalls
}

WallOpt.prototype.AddNewPolyLine = function (e, t) {
  return e != ConstantData.ObjectTypes.SD_OBJT_FLOORPLAN_WALL ? null : new PolyLineContainer(t)
}

WallOpt.prototype.AddCornerCancel = function () {
  T3Gv.optManager.SetEditMode(ConstantData.EditState.DEFAULT),
    T3Gv.optManager.CancelModalOperation(),
    T3Gv.optManager.ResetObjectDraw(),
    // T3Gv.optManager.UpdateTools(),
...
WallOpt.prototype.AddCorner = function (e) {
  try {
    var t,
      a,
      r;
...
WallOpt.prototype.MoveOutline = function (e) {
...
WallOpt.prototype.AddCornerStart = function (e) {
...
WallOpt.prototype.PostObjectDrawHook = function (e) {
...
WallOpt.prototype.NotifySetEditMode = function (e) {
...
WallOpt.prototype.AddMeasureLine = function () {
...
WallOpt.prototype.AddMeasureArea = function () {
  var e = T3Gv.objectStore.GetObject(T3Gv.optManager.theSEDSessionBlockID).Data,
    t = 0 == (e.def.textflags & ConstantData.TextFlags.SED_TF_HorizText),
...
WallOpt.prototype.AlwaysShowLayers = function () {
  return !0
}

WallOpt.prototype.AddWallOpening = function (e) {
...
WallOpt.prototype.SplitWall = function (e) {
  try {
    var t = {};
    e.stopPropagation(),
      e.preventDefault();
...
WallOpt.prototype.SplitWallStart = function (e) {
...
WallOpt.prototype.EnsureCubicleBehindOutline = function (e) {
...
WallOpt.prototype.AllowAutoInsert = function () {
  return !1
}

WallOpt.prototype.GetAutomationContext = function () {
