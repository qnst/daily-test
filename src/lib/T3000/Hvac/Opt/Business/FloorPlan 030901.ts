...
class FloorPlan {
  ...
  AddWall(event, additionalData) {
    ...
    console.log('= FloorPlan AddWall o', wallStyle);
  ...
  AddCorner(event) {
    ...
    try {
      ...
      if (event.gesture) {
        ...
        hitPoint = Utils1.DeepCopy(T3Gv.optManagerrightClickParams.HitPt);
        targetId = T3Gv.optManagerrightClickParams.TargetID;
  ...
  GetAutomationContext() {
    ...
    const result = Resources.Contexts.FloorPlan;
