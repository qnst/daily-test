...
class DSOpt {
  ...
  //   return 60 === t ? new T3DataStream(e, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.UIInfoStruct60) : 56 === t ? new T3DataStream(e, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.UIInfoStruct56) : 52 === t ? new T3DataStream(e, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.UIInfoStruct52) : 40 === t ? new T3DataStream(e, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.UIInfoStruct40) : 36 === t ? new T3DataStream(e, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.UIInfoStruct36) : new T3DataStream(e, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.UIInfoStruct)
  // }
  ...
  //     ? new T3DataStream(buffer, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.DrawObj7Struct20)
  //     : new T3DataStream(buffer, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.DrawObj7Struct48);
  // }
  ...
  //   return 20 === structSize
  //     ? new T3DataStream(buffer, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.DrawObj6Struct20)
  //     : new T3DataStream(buffer, null, T3DataStream.LITTLE_ENDIAN).readStruct(DSConstant.DrawObj6Struct);
  // }
