...
class Document extends Container {
  ...
  ImageLoadAddRef() {
    console.log('= B.Document ImageLoadAddRef input');
    this.imageLoadRefCount++;
    console.log('= B.Document ImageLoadAddRef output', { imageLoadRefCount: this.imageLoadRefCount });
  }

  ImageLoadDecRef() {
    console.log('= B.Document ImageLoadDecRef input');
    this.imageLoadRefCount = Math.max(0, this.imageLoadRefCount - 1);
    console.log('= B.Document ImageLoadDecRef output', { imageLoadRefCount: this.imageLoadRefCount });
  }

  ImageLoadGetRefCount() {
    console.log('= B.Document ImageLoadGetRefCount input');
    const refCount = this.imageLoadRefCount;
    console.log('= B.Document ImageLoadGetRefCount output', { refCount });
    return refCount;
  }

  ImageLoadResetRefCount() {
    console.log('= B.Document ImageLoadResetRefCount input');
    this.imageLoadRefCount = 0;
    console.log('= B.Document ImageLoadResetRefCount output', { imageLoadRefCount: this.imageLoadRefCount });
  }
