 ...
 *
 * @example
 * Creating and using an instance of RightClickData:
 * ```typescript
 * const rightClickData = new RightClickData();
 * rightClickData.targetId = 101;
 * rightClickData.segment = 3;
 * rightClickData.hitPoint = { x: 120, y: 250 };
 * rightClickData.locked = true;
 * rightClickData.context = 2;
 *
