 ...
 *
 * @example
 * // Creating and configuring a SEDAHook instance
 * const hook = new SEDAHook();
 ...
 *
 * @remarks
 * The SEDAHook class provides a structured approach to manage hook connections by bundling
