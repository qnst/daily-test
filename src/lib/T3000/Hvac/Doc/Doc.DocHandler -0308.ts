...
import DocumentConfig from '../Model/DocConfig'
...
class DocUtil {
  ...
  ShowCoordinates(show: boolean): boolean {
    ...
    //     if (targetSelect > 0) {
    //       const obj = T3Gv.optManager.GetObjectPtr(targetSelect, false);
    //       let dimensions = null;
    //       if (obj && obj.GetDimensionsForDisplay) {
    //         dimensions = obj.GetDimensionsForDisplay();
    //       }
    //       T3Gv.optManager.UpdateDisplayCoordinates(dimensions, null, null, obj);
  ...
  RulerTopDoubleClick(event) {
    ...
    T3Gv.docHandler.RulerHandleDoubleClick(event, false, true);
  ...
  RulerLeftDoubleClick(event: any): void {
    ...
    Utils2.StopPropagationAndDefaults(event);
    T3Gv.docHandler.RulerHandleDoubleClick(event, true, false);
  ...
  RulerCenterDoubleClick(event: any): void {
    ...
    Utils2.StopPropagationAndDefaults(event);
    T3Gv.docHandler.RulerHandleDoubleClick(event, true, true);
  ...
  RulerDragStart(event: any): void {
    ...
    if (!T3Gv.docHandler.IsReadOnly()) {
      ...
      T3Gv.docHandler.rulerInDrag = true;
      console.log("= D.DocHandler: RulerDragStart - Output:", { rulerInDrag: T3Gv.docHandler.rulerInDrag });
    } else {
  ...
  RulerTopDrag(e) {
    ...
    if (T3Gv.optManager.IsCtrlClick(e)) {
  ...
  RulerLeftDrag(event: any) {
    ...
    T3Gv.docHandler.RulerDragGuides(event, true, false);
