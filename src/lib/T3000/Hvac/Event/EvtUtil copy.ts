...
const EvtUtil = {
  ...
  Evt_WorkAreaHammerPan: null,
  Evt_WorkAreaHammerPanEnd: null,
}
 ...
 */
EvtUtil.Evt_MouseMove = function (mouseEvent) {
 ...
 */
EvtUtil.Evt_WorkAreaHammerClick = function (event) {
 ...
 */
EvtUtil.Evt_WorkAreaMouseWheel = function (event) {
  ...
  if (event.ctrlKey) {
    ...
    T3Gv.docHandler.SetScroll(scrollLeft - xOffset, scrollTop - yOffset);
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_WorkAreaHammerPanEnd = function (event) {
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_WorkAreaHammerDragStart = function (event) {
 ...
 */
EvtUtil.Evt_RubberBandDrag = function (event) {
 ...
 */
EvtUtil.Evt_RubberBandDragEnd = function (event) {
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_WorkAreaHammerDrawStart = function (hammerEvent) {
 ...
 */
EvtUtil.Evt_DrawTrackHandlerFactory = function (drawableObject) {
 ...
 */
EvtUtil.Evt_DrawReleaseHandlerFactory = function (drawableObject) {
 ...
 */
EvtUtil.Evt_ShapeTapFactory = function (shape) {
    ...
    switch (T3Gv.optManager.currentModalOperation) {
      case ConstantData2.ModalOperations.NONE:
        ...
        if (!T3Gv.optManager.CheckTextHyperlinkHit(shape, tapEvent)) {
          ...
          if (T3Gv.optManager.GetUIAdaptation(tapEvent) && !T3Gv.docHandler.IsReadOnly()) {
 ...
 */
EvtUtil.Evt_ShapeDragStartFactory = function (shape) {
 ...
 */
EvtUtil.Evt_ShapeHoldFactory = function (shape) {
 ...
 */
EvtUtil.Evt_ShapeDoubleTapFactory = function (shape) {
 ...
 * @param event - The drag event from the hammer.js gesture system
 */
EvtUtil.Evt_ShapeDrag = function (event) {
 ...
 * @param event - The drag end event from the hammer.js gesture system
 */
EvtUtil.Evt_ShapeDragEnd = function (event) {
 ...
 */
EvtUtil.Evt_ActionTrackHandlerFactory = function (actionObject) {
 ...
 */
EvtUtil.Evt_ActionReleaseHandlerFactory = function (actionObject) {
 ...
 */
EvtUtil.Evt_StampObjectDragEndFactory = function (stampObject) {
 ...
 */
EvtUtil.Evt_StampObjectDrag = function (event) {
 ...
 */
EvtUtil.Evt_MouseStampObjectMove = function (mouseEvent) {
 ...
 */
EvtUtil.Evt_MouseStampObjectDoneFactory = function (stampObject) {
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_ActionTriggerTap = function (event) {
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_WorkAreaHammerPinchIn = function (event) {
  ...
  let zoomFactorPercent = Math.round(100 * T3Gv.docHandler.GetZoomFactor());

  if (zoomFactorPercent > 50) {
    // Decrease zoom factor but don't go below 50%
    zoomFactorPercent = Math.max(50, zoomFactorPercent - 50);
    T3Gv.docHandler.SetZoomFactor(zoomFactorPercent / 100);
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_WorkAreaHammerPan = function (event) {
  ...
  T3Gv.docHandler.SetScroll(scrollLeft - deltaX, scrollTop - deltaY);
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_WorkAreaHammerPinchOut = function (event) {
 ...
 */
EvtUtil.Evt_WorkAreaHammerPinchEnd = function (event) {
 ...
 */
EvtUtil.Evt_DimensionTextKeyboardLifter = function (element, keyboardEvent) {
 ...
 */
EvtUtil.Evt_DimensionTextDoubleTapFactory = function (shape, textId) {
 ...
 */
EvtUtil.Evt_DimensionTextTapFactory = function (shape, textId, preventPropagation) {
 ...
 */
EvtUtil.Evt_PolyLineDrawExtendHandlerFactory = function (polyLineObject) {
 ...
 */
EvtUtil.Evt_DrawExtendHandler = null;
 ...
 * @returns false to prevent default browser behavior
 */
EvtUtil.Evt_PolyLineDrawDragStart = function (event) {
