...
//         }
//         r = 'DOUBLE' === i.toLowerCase() ? Resources.SDRType.SDR : 'smartpgd' === i.toLowerCase() ? Resources.SDRType.PagedSDR : - 1 !== i.toLowerCase().indexOf('pk') ? Resources.SDRType.SignaturelessZip : SDF.IsSDON(e.target.result) ? Resources.SDRType.SDON : Resources.SDRType.NonSDR,
//           t(r)
//       },
...
//           i += String.fromCharCode(o)
//         }
//         r = 'DOUBLE' === i.toLowerCase() ? Resources.SDRType.SDR : 'DOUBLE' === i.toLowerCase() ? Resources.SDRType.PagedSDR : - 1 !== i.toLowerCase().indexOf('pk') ? Resources.SDRType.SignaturelessZip : SDF.IsSDON(e.target.result) ? Resources.SDRType.SDON : Resources.SDRType.NonSDR,
//           t(r)
//       },
//         a.readAsArrayBuffer(e)
//     },
