  ...
  var g,
    ...
    v = (n.utils = {
      ...
      inWorkAreaScrollbar: function (t) {
        ...
        // Double ====
        // var n = document.getElementById(e.docUtil.svgAreaID),
    ...
    b = (n.event = {
      ...
      onTouch: function (t, n, o) {
        ...
        // console.log("HammerJS==== onTouch 3 e.docUtil", e.docUtil);
        ...
        var a = function (i) {
          ...
          // debugger;
          var a;
          if (e.docUtil && n == p && v.inWorkAreaScrollbar(i)) {
            return;
          }
          if (n == p) {
            r.shouldDetect = true;
        ...
        /*
          var r = this
            , a = function(i) {
              var a;
              e.docUtil && n == p && v.inWorkAreaScrollbar(i) || (n == p && (r.shouldDetect = !0),
