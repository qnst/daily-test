...
class OptHandler {
  ...
  AddNewObject(drawingObject, shouldStyleCopy, renderSelection, textContent) {
    ...
    if (false/*Collab.IsProcessingMessage()*/) {
 ...
 */
  ...
  */
  ...
  // /**
  //  * Determines if the active layer in the document is a planning document type.
  //  * Checks through all layers to see if the active one is a mind map or Gantt chart.
  //  *
  //  * @returns The layer type constant if the active layer is a planning document (mind map or Gantt),
  //  *          or 0 if the active layer is not a planning document type
  //  */
  // IsPlanningDocument() {
